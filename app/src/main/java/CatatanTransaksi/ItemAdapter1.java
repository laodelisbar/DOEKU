...
public class ItemAdapter1 extends RecyclerView.Adapter<ItemAdapter1.ItemViewHolder> {
    ...
    private DatabaseTransaksi1 db;

    public ItemAdapter1(Context context, ArrayList<Item1> itemList) {
        mContext = context;
        mItemList = itemList;
        db = new DatabaseTransaksi1(context); // Inisialisasi database
    }

    public void setItemList(ArrayList<Item1> itemList) {
        mItemList = itemList;
    ...
    private void showDeleteDialog(Item1 item, int position) {
        new AlertDialog.Builder(mContext)
    ...
    private void showEditDialog(Item1 item, int position) {
        ...
        builder.setPositiveButton("Ya", (dialog, which) -> {
            ...
            Intent intent = new Intent(mContext, InputKategori2.class);
